...
public class RegistroActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Departamento=(TextView)findViewById(R.id.txtDepa);
        ...
        final String[] depa =
                {"Recursos Humanos","Servicios Escolares","Desarrollo Academico",
                        ...
                        "Centro de información","Dirección","Sub-Dirección","Centro de Cómputo"
        ...
        Departamento.setText(text);
        spin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {

            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id)
            {
                //Aqui se muestra el nombre del departamento al que pertenece el usuario en un textview
        ...
        protected Void doInBackground(Usuario... params) {
            ...
            try {
                ...
                api.CrearNuevoUsuario(params[0].getCorreoElectronico(),
                        params[0].getNombreUsuario(), params[0].getContrseña()
                        , params[0].getDepartamento());
