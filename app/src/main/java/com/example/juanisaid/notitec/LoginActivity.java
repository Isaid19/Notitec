...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Clave = (EditText)findViewById(R.id.txtClaveMaestra);
        alumno = (Button)findViewById(R.id.btnAlumno);
        acerca= (Button)findViewById(R.id.btnTerminos);
...
//        });
        ...
        alumno.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),ListaPublicacionActivity.class);
                startActivity(i);
            }
        });
